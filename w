...
cl = LINETCR.LINE()
cl.login(token="EncE2ZeqD7rnivS21fw7.o3jQj3h52i+lbSgS2vEtXW.0lxfvW2iJqiBN+BvR8QjURN2+eDko0eDaZEgtubxjoA=")
#cl.login(token='')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token="En5Weiy8N9S0qUPyooFb.Misl0XRAYwHw8d/7r5Ie/W.+3AyTnvDjyQ+jM1bsZqRetngG0ts/pNcDaKsPw2JWgo=")
#ki.login(token='')
ki.loginResult()
...
kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="EnN9DLWlah4LrVHNctd3.Ckq21ucSBjBad7CUJtV5qW.f3OHWhGrDZOJYiz6dQ7tkiUm6G3X+/3EOc9vx7Nbyl4=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="En2dUfDPs0CFp4VE9xee.tz84mK0ztxy/uNAt8nNlBG.ib/Kv944ZUzIFFNaS40w8dIJ+n7BozqYNo07CzEpxfQ=")
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="EnPSpeKlk8QJc3tP7uT6.CmtiX7ZQZOz1j75dCRSU1G.mD10sZy6JfR1M4LBx92MfNkJdbdDxVSz6LSCuth7u4I=")
kr.loginResult()
...
admin=["u00f827ce6641038d7c9b6704a9777dfa,""u3b726a2771f9d88fcb06c1acd95793c7"]
...
#--------------------------------------------------------
	    if mid in op.param3:
			...
			cl.updateGroup(G)
			cl.sendText(op.param1,"Hello all\n\nSELFBOT PHET HACK BOT")
                else:
